<%@ Page Title="" Language="C#" MasterPageFile="~/DLC/MainMenu.Master" AutoEventWireup="true" CodeBehind="EditCourse.aspx.cs" Inherits="QLDT.DLC.EditCourse" %>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <asp:TextBox runat="server" ReadOnly="true" ID="txtUpdated" class="form-control datetimepicker-input" data-target="#reservationdate" AutoCompleteType="Disabled"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
