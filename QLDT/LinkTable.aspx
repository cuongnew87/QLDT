<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="LinkTable.aspx.cs" Inherits="QLDT.LinkTable" %>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="AdminDashboard1.aspx">Dashboard v1</a></li>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <asp:DropDownList runat="server" class="custom-select" ID="ddlTeacher">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Teacher Name</label>
                                <asp:TextBox runat="server" class="form-control" ID="txtTeacher" placeholder="Teacher name" ReadOnly="true"></asp:TextBox>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <asp:Button runat="server" Text="Refresh" ID="btnRefresh" OnClick="btnRefresh_Click" class="btn btn-primary"></asp:Button>
                            </div>
                        </div>
                    </div>
                </div>
