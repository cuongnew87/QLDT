<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Compose.aspx.cs" Inherits="QLDT.Compose" %>
                    ...
                    <div class="col-md-9">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <asp:TextBox runat="server" ID="compose_textarea" class="form-control" Style="height: 300px" TextMode="MultiLine">
                    </asp:TextBox>
                                </div>
                                <div class="form-group">
